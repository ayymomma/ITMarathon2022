...
class CustomButton(QPushButton):
    ...
    def __init__(self, parent, text, minimumXSize, maximumXSize, ySize, bgColor="rgba(85, 47, 208, 255)",
                 bdColor="rgba(162, 85, 232, 255)", color="rgba(255, 255, 255, 255)", textWeight=30, bold=True):
